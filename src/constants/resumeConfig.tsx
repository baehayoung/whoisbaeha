...
const workList:Array<experienceProps> = [
    {
        ...
        works: ['React(Enact) 기반 앱 개발', 'Family Settings, Game Home 앱 신규 개발', 'Settings, Software Update, First Use 앱 유지 보수 (신규 요구사항 대응 및 이슈 개선)'],
...
본 과정으로 현재 근무하고 있는 회사에 입사할 수 있었습니다.`,
        works: ['Node.js 기반 서버 개발', 'HTML 및 JS 기반 사용자 화면 개발', '현업 프로세스 및 테스트 방법 습득'],
...
const frontEndProjList:Array<projectProps> = [
    ...
    }, 
    {
        ...
        details: [
            '유지 보수 - 새로운 기능 코드 추가 개발 및 변경되는 스펙 및 이슈 관리.',
